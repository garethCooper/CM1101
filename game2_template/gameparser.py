...
def filter_words(words, skip_words):
    ...
    return word_list
#this function should, cross check a players input against a table of chosen skip words
#it will ignore those skip words and use the rest of the input to carry on the game
...
def normalise_input(user_input):
    ...
    key_words = filter_words(filter_list, skip_words)
    return key_words
#should remove punctuation and spaces from player input
