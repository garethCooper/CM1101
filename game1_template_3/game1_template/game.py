...
def remove_spaces(text):
    ...
    text = text.strip() 
    return text
#takes spaces from the front and end of player input
...
#removes spaces and punctuation from player input and puts it into lowercase, players don't see this happen
#cooperates with other functions to achieve this
...
def display_room(room):
    ...
    print("")
    #display room names and descriptions of said rooms
...
def exit_leads_to(exits, direction):
    ...
    'Reception'
    """
    return rooms[exits[direction]]["name"]#not working
    #shows the rooms leading from the one the player currently occupies
#e.g. while in the reception west is the tutor
...
def print_menu_line(direction, leads_to):
    ...
    #ties in with print_menu, this creates the text that it uses
...
def print_menu(exits):
    ...
    for direction in exits:
        ...
        #a loop that shows the player a list of directions they can travel in
...
def is_valid_exit(exits, user_input):
    ...
    if exits.get(user_input): 
        ...
        return False
    #simple if statement to make sure a chosen exit is valid
...
def menu(exits):
    ...
    while True:
       print_menu(exits)
       #shows the player their currently available exits
       user_input=str(input())
       #stores the players input as a string
       user_input=normalise_input(user_input)
       #normalises player input aka takes variations of their directions and turns
       #it into lowercase equivalent e.g. WEST becomes west, the player doesn't see this
       if is_valid_exit(exits, user_input):
        #if statement to make sure the player enters appropriate choice
           return user_input
       	    #shows the player the choice they made
...
def move(exits, direction):
    ...
    False
    """
    return rooms[exits[direction]]#not working
    #retrieves exit information from dictionaries relevant to the currently occupied room
